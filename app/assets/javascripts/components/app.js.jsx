...
var MainComponent = React.createClass({
  ...
  handleSubmit: function(newItem){
    $.ajax({
      ...
      data: {task: newItem},
      success: function(data){
        this.setState({task: '', todoList: data});
      }.bind(this)
    });
  },
  handleDelete: function(itemToBeDeleted){
    event.preventDefault();
    $.ajax({
      url: '/todos/'+itemToBeDeleted.id,
      dataType: 'json',
      method: 'DELETE',
      success: function(data){
        this.setState({task: '', todoList: data});
  ...
  displayItem: function(item){
    return(
      <li key={item.id} className='list-group-item'>
        ...
        <a href="#" > | Done</a>
        <a href="#" > | Follow up</a>
        <a href="#" onClick={this.props.handleDelete.bind(null, item)}> | Remove</a>
      </li>
    );
  },
  render: function(){
